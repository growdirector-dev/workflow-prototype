    ...
    steps: [
      {
        ...
        sensorRows: [
          { sensorId: 's1', operator: '>', from: 26, currentValue: 28.3, until: 24 },
          { sensorId: 's2', operator: '<', from: 40, currentValue: 38,   until: 40 },
        ],
      ...
      },
      {
        ...
        sensorRows: [
          { sensorId: 's1', operator: '>', from: 26, currentValue: 28.3, until: 24 },
          { sensorId: 's2', operator: '<', from: 40, currentValue: 38,   until: 35 },
        ],
    ...
    steps: [
      {
        ...
        deviceId: 'd6',
        actionType: 'Regular',
        sensorRows: [{ sensorId: 's7', operator: '<', from: 1.8, currentValue: 1.5, until: 2.2 }],
        params: {},
        status: 'pending',
      },
      {
    ...
    steps: [
      {
        ...
        deviceId: 'd9',
        actionType: 'Regular',
        sensorRows: [{ sensorId: 's3', operator: '<', from: 800, currentValue: 750, until: 1200 }],
        params: {},
        status: 'pending',
      },
      {
