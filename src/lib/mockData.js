...
// ─── Mock workflows ────────────────────────────────────────────────────────────
// Default Workflows:  Climate (priority 1), Irrigation (priority 2)  — per spec.
// Both start Disabled, Sensor mode, empty steps (ready to configure).
// Non-default workflows start at priority 3+.
// ──────────────────────────────────────────────────────────────────────────────

export const initialWorkflows = [

  // ── Default #1: Climate — priority 1, Sensor, Disabled ──
  {
    id: 'wf_climate',
    name: 'Climate',
    priority: 1,
  ...
  // ── Default #2: Irrigation — priority 2, Sensor, Disabled ──
  {
    id: 'wf_irrigation',
    name: 'Irrigation',
    priority: 2,
  ...
  // ── Ventilation — priority 3, Sensor, Running ──
  {
    id: 'wf1',
    name: 'Ventilation',
    priority: 3,
    ...
    trigger: {
      type: 'sensor',
      sensors: [
        { sensorId: 's1', operator: 'Higher than', value: 26, unit: '°C', currentValue: 28.3 },
    ...
    steps: [
      {
        ...
        sensorRows: [
          { sensorId: 's1', from: 26, currentValue: 28.3, until: 24 },
          { sensorId: 's2', from: 40, currentValue: 38,   until: 40 },
        ],
  ...
  // ── Fertigation — priority 4, Sensor, Synchronizing ──
  {
    id: 'wf2',
    name: 'Fertigation',
    priority: 4,
    ...
    steps: [
      {
        ...
        deviceId: 'd6',
        actionType: 'Regular',
        sensorRows: [{ sensorId: 's7', from: 1.8, currentValue: 1.5, until: 2.2 }],
        params: {},
        status: 'pending',
      },
      {
  ...
  // ── CO₂ Management — priority 5, Sensor, Idle ──
  {
    id: 'wf3',
    name: 'CO₂ Management',
    priority: 5,
    ...
    steps: [
      {
        ...
        deviceId: 'd9',
        actionType: 'Regular',
        sensorRows: [{ sensorId: 's3', from: 800, currentValue: 750, until: 1200 }],
        params: {},
        status: 'pending',
      },
      {
  ...
  // ── Morning Irrigation — priority 6, Schedule, Completed ──
  // Demonstrates the `completed` status.
  {
    id: 'wf4',
  ...
  // ── Evening Mist — priority 7, Schedule, Error, Disabled ──
  {
    id: 'wf5',
    name: 'Evening Mist',
    priority: 7,
